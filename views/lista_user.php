<?php
    require_once '../controller/userSesion.php';

    if( ! UserSesion::isAdmin() )
    {
        header('location: lista_tabata.php');
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="text-right pb-5 pr-5">
    <a href="crearTabata.php" class="btn btn-success btn-sm btn-round text-white  " >Crear usuario</a>
</div>
<div class="container">
